...
export type StorageHash =
  StorageHashBase<'15128430aa611e633134adfac6a92986c1019a786fb4e7c44b543bd4c1eb4c19'>;
export type ExecutionHash =
  ExecutionHashBase<'e06b35308ae2af0dab4fa40832fc4617f5467b97c7c15e74386bea570ecdbbac'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly HydrationRecord: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly date: CodecTypes['pg/date-string@1']['output'];
      readonly waterIntake: CodecTypes['pg/int4@1']['output'];
    ...
    readonly UserSettings: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly dailyGoal: CodecTypes['pg/int4@1']['output'];
      readonly servingSize: CodecTypes['pg/int4@1']['output'];
      readonly measurementUnit: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    readonly HydrationRecord: {
      ...
      readonly waterIntake: CodecTypes['pg/int4@1']['input'];
    ...
    readonly UserSettings: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly userId: CodecTypes['pg/int4@1']['input'];
      readonly dailyGoal: CodecTypes['pg/int4@1']['input'];
      readonly servingSize: CodecTypes['pg/int4@1']['input'];
      readonly measurementUnit: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
...
export namespace Models {
  export type public_User = {
    ...
    hydration: public_HydrationRecord[];
    settings: public_UserSettings | null;
    readonly [RelationKeys]?: 'hydration' | 'settings';
  };
  export type public_UserSettings = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    dailyGoal: CodecTypes['pg/int4@1']['output'];
    servingSize: CodecTypes['pg/int4@1']['output'];
    measurementUnit: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    user: public_User;
    readonly [RelationKeys]?: 'user';
  };
  export type public_HydrationRecord = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    date: CodecTypes['pg/date-string@1']['output'];
    waterIntake: CodecTypes['pg/int4@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    user: public_User;
    readonly [RelationKeys]?: 'user';
...
export declare const models: {
  public: {
    ...
    HydrationRecord: Models.public_HydrationRecord;
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly hydrationRecord: {
              ...
              indexes: readonly [
                {
                  readonly name: 'hydrationRecord_userId_idx_a489d58a';
                  readonly prefix: 'hydrationRecord_userId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'hydrationRecord';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly userSettings: {
              columns: {
                ...
                readonly dailyGoal: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/int4@1', 2500>;
                  };
                };
                ...
                readonly measurementUnit: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'ml'>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
...
> & {
  ...
  readonly roots: {
    ...
    readonly hydrationRecord: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'HydrationRecord';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly HydrationRecord: {
            ...
            readonly storage: {
              readonly table: 'hydrationRecord';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly date: { readonly column: 'date' };
                readonly waterIntake: { readonly column: 'waterIntake' };
          ...
          readonly UserSettings: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly dailyGoal: { readonly column: 'dailyGoal' };
                readonly servingSize: { readonly column: 'servingSize' };
                readonly measurementUnit: { readonly column: 'measurementUnit' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
